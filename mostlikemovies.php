...
<div class="catalog">
	<div class="container">
		<div class="row">
			...
			$data = mysqli_query($db, "SELECT * from tb_film where jenis='movie' ORDER BY `tb_film`.`likes` DESC");
			$jumlah_data = mysqli_num_rows($data);
			$total_halaman = ceil($jumlah_data / $batas);

			$dataFilm = mysqli_query($db, "SELECT * from tb_film where jenis='movie' ORDER BY `tb_film`.`likes` DESC limit $halaman_awal, $batas");
