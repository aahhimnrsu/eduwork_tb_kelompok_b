...
<div class="page-content">
    ...
    <section class="no-padding-top no-padding-bottom">
        <div class="container-fluid">
            <div class="block">
                <div class="title">Add New Movies</div>
                <form action="proses/prosestambahmovie.php" method="post" enctype="multipart/form-data">
                    <div class="row mb-3">
                        <div class="col-md-12">
                            Title
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12 d-flex justify-content-end">
                            <button class="btn btn-primary btn-sm">+ Add New Movie</button>
                        </div>
                    </div>
                </form>
            </div>
