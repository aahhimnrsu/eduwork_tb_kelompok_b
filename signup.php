...
<head>
	...
	<title>B-Mov – Online Movies, TV Shows & Cinema HTML Template</title>
			...
			<div class="row">
				<div class="col-12">
					<div class="sign__content">
						<!-- registration form -->
						<form action="proses/signup.php" class="sign__form" method="post">
							<a href="index.php" class="sign__logo">
								<img src="assets/img/logo.png" alt="">
							</a>

							<div class="sign__group">
								<input type="text" class="sign__input" placeholder="Name" name="nama">
							</div>
